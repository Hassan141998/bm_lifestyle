...
def shop():
    ...
    return render_template('shop.html', products=products, pagination=pagination, title='Shop')
...
def admin_dashboard():
    ...
    pagination = Product.query.order_by(Product.id.desc()).paginate(page=page, per_page=per_page, error_out=False)
    products = pagination.items
    return render_template('admin_dashboard.html', products=products, pagination=pagination)
